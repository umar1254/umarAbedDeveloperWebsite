// This file now contains all the JavaScript logic.
// It is correctly linked in index.html as <script src="funtionality.js"></script>
...
(function() {
    ...
    const toggleMenu = () => {
        ...
        // FIX: Toggling the 'active' class on the mobile menu container.
    ...
    function showModal(mode, content) {
        ...
        if (mode === 'input') {
            ...
            // Hide the prompt text when only a message is displayed
     ...
     * This function needs to be globally accessible for the onclick attributes in the HTML.
     */
